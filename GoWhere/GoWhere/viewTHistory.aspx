<%@ Page Title="Tour Guide - View Tour History" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="viewTHistory.aspx.cs" Inherits="viewTHistory" Debug="true"%>

<asp:Content ID ="loginUser" ContentPlaceHolderID="loginUser" runat="server">
    Logged in: <b><u>Tour Guide</u></b>
</asp:Content> 

<asp:Content ID ="menubarViewTHist" ContentPlaceHolderID="menubar" runat="server">
    <ul>
       <li>
             <img src = "GoWhere/Images/back.png" height = "30" width = "30">
             <asp:HyperLink ID="backTGProfile" runat="server" NavigateUrl="~/viewTHistoryList.aspx"> BACK </asp:HyperLink>    
       </li>
        <li>
...
<asp:Content ID="viewTourHistContent" ContentPlaceHolderID="content" Runat="Server">
    <asp:Table ID="TGTourHistTable" runat="server">
        <asp:TableHeaderRow>
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                <asp:Button ID="connectTR" runat="server" Text="View List of Tourists" PostBackUrl="~/viewListTR.aspx" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Content>
